...
class view
{
    ...
    {
        $sql = "SELECT nota.*, barang.id_barang, barang.nama_barang, member.id_member, member.nm_member, 
                vouchers.id_voucher, vouchers.voucher_code, vouchers.discount_percentage
                FROM nota
                LEFT JOIN barang ON barang.id_barang = nota.id_barang
                LEFT JOIN member ON member.id_member = nota.id_member
                LEFT JOIN vouchers ON vouchers.id_voucher = nota.id_voucher
                WHERE nota.periode = ?
